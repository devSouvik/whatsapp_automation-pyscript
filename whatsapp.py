...
#  step 4->  if you want to send multiple messages from 1 script...don't forget to give  a time diff of minimum 5 minutes from the previous message....


#  format --->>> kit.sendwhatmsg("phone number with +91","text message ",hour(in 24 hrs format),minutes) 
